...
function displayWeather(forecast, city) {
  ...
  const todayHTML = `
        <div class="weather-card">
            ...
            <div class="m-2 d-flex str">
                <p><img class="me-2" src="imges/icon-umberella.png" alt="">${today.day.daily_chance_of_rain}%</p> 
                <p><img class="me-2 ms-3" src="imges/icon-wind.png" alt=""> ${today.day.maxwind_kph} km/h </p> 
                <p><img class="me-2 ms-3" src="imges/icon-compass.png" alt="">${today.hour[0].wind_dir}</p>
            </div>
        </div>
    `;
